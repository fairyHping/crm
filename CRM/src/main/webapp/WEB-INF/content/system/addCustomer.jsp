			...
			<div id="main" class="easyui-panel">
				<table style="text-align: center">
					...
					<tr>
						...
						<td><input type="radio" name="ownership" value="合资">合资 <input
							type="radio" name="ownership" value="国企">国企 <input type="radio"
							name="ownership" value="民营">民营</td>
					...
					<tr>
						...
						<td><input type="radio" name="rating" value="一星">一星 <input
							type="radio" name="rating" value="二星" >二星 <input type="radio"
							name="rating" value="三星">三星
							 <input type="radio"
							name="rating" value="四星">四星
							<input type="radio"
							name="rating" value="五星">五星</td>
				</tr>
				<tr>
