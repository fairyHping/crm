    	...
    	<script type="text/javascript">		
    	  ...
    	  //新建客户信息在弹窗页面
      	 $("#tabx").on("click",function(){	          
              	parent.openTopWindow({url :"system/customer/addPool",
      		 	title:"客户信息",	   		 	
      		 	 width : 800,
                height : 500,
                onClose : function() {
   	 ...
   	 function loadCustomer(date){
   		 $("#customerList").datagrid('load', date);
   			...
   			$(function(){
   				$("#customerList").datagrid({
   					...
   					columns : [[
   						...
   						{field:'cUser',title:'创建者',width:70,align:'center',formatter:function(value){
   							if(value){
   			...
   			$("#updateBtn").on("click", function(event) {
   				...
   				$.each(rows, function(index, obj) {
   				 ...
   				 /*  //编辑客户信息在弹窗页面 */
   			             ...
   			             url :"system/customer/editPool?customerId="+customerIds,
   			   		 	title:"编辑客户",	
   			   		      width : 800,
   			              height : 500,
   			             onClose : function() {
           	...
           	function detail(customerId){	
   				parent.openTopWindow({
   		   		 url:"system/customer/findPool?customerId="+customerId,
   	   		 	title:"查看客户详情",	   		 	
   	   		 	width : 800,
                   height : 400,
                   onClose : function() {
