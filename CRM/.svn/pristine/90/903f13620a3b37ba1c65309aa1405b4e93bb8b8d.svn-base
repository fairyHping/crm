			...
			<div id="main" class="easyui-panel">
				<table style="text-align: center">
					...
					<tr>
						...
						<td class="td1">客户：</td>
						<td class="td2"><input type="hidden" name="id" value="${business.id}">
						<input type="hidden" name="customerId" value="${business.customer.customerId}">
						<input 
							name="name" id="name" value="${business.customer.name}" 
...
$(function() {
	...
	$(".save").on(
			...
			function(event) {
				...
				$.post("system/business/edit", $("#leadsForm").serialize(),
						function(data) {
							if (data.success) {
